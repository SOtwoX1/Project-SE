...
import { baseRestaurantRouteURL, getAllRestaurantAPI } from "../../server/routes/restaurantRoutes";
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${baseRestaurantRouteURL}${getAllRestaurantAPI}`);
